...
<body>
    ...
    <div class="full-container">
        <div style="width: 100%; background: #fff;">
            <div style="max-width: 1600px; margin-inline: auto; position: relative;">
            ...
            <div style="height: 100%; padding: 50px 15px 0;" class="main-content-container">
                <div style="width: 100%; gap: 80px;" class="d-flex justify-content-between align-items-start">
                    <div>
                        ...
                        <div style="font-size: 12px; font-weight: 300; padding: 15px 0 0; color: rgba(250, 249, 246, 1);">
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Obcaecati temporibus tenetur, necessitatibus officiis quisquam consectetur. Blanditiis autem ipsum eos aut?
                        </div>
                    </div>
                    <div>
                        <div>
                    ...
                    <div>
                        ...
                        <div style="padding: 20px 0 0; gap: 10px;" class="d-flex justify-content-between align-itemcenter">
                            <div style="width: 60px;" class="d-f;ex">
