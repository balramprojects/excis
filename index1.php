...
<body>
    ...
    <div id="landing-header-menu" style="position: sticky; top: 0; z-index: 2;">
        ...
        <div class="full-container">
            <div
                ...
                <div style="height: 100%; padding: 0 15px;" class="main-content-container">
                    <div style="width: 100%; height: 100%;" class="d-flex justify-content-between">
                        <a href="index1.html" title="Excis Logo" style="margin: 0 70px 0 0;"
                            class="d-flex align-items-center">
    ...
    <div class="full-container">
        <div
            style="height: 520px; width: 100%; background-image: url('assets/images/homepage.jpg'); background-size: 100% 100%; background-repeat: no-repeat; border-radius: 0 0 50px 50px;">
            <!-- <div style="height: 520px; width: 100%; background-image: url('assets/images/banner-bg.png'); background-size: 100% 100%; background-repeat: no-repeat; border-radius: 0 0 50px 50px;"> -->
