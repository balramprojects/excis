            ...
            <div class="main-content-container">
                <div class="banner-txt d-flex flex-column justify-content-center">
                    <div class="breadcrumb">
                        <a href="<?php echo $desktop_url; ?>">Home</a> - <a href="<?php echo $desktop_url . 'about-us'; ?>">About Us</a> - <span class="page">CSR</span>
                    </div>
                    ...
                    <div class="page-about-feature-content d-flex justify-content-between align-items-center">
                        <div class="txt-content">
                            ...
                            <div class="m-creative d-flex">
                                <img src="<?php echo $desktop_images . 'csr/csr-madgascar-1.jpg'; ?>" alt="CSR">
                            </div>
        ...
        <div class="blue-container-bg">
            <div class="main-content-container">
                <div class="container-txt-content">
                    <div class="heading-txt">
                        Reforestation Initiative Gallery
                    </div>
                    <div class="sub-txt">
                        Explore the journey of Excis' 1000-tree planting project in Madagascar, showcasing the efforts of our team and community towards a sustainable future.
                    </div>
                </div>

                <div style="padding: 40px 0 0;">
                    <div style="display: grid; grid-template-columns: repeat(12, 1fr); gap: 15px;">
                        <div style="grid-column: 1 / span 8; grid-row: 1 / span 6;">
                            <div style="width: 100%;" class="d-flex">
                                <img src="<?php echo $desktop_images . 'csr/csr-madgascar-1.jpg'; ?>" alt="">
                            </div>
                        </div>
                        <div style="grid-column: 9 / span 4; grid-row: 1 / span 2;">
                            <div style="width: 100%;" class="d-flex">
                                <img src="<?php echo $desktop_images . 'csr/csr-madgascar-2.jpg'; ?>" alt="">
                            </div>
                        </div>
                        <div style="grid-column: 9 / span 4; grid-row: 3 / span 2;">
                            <div style="width: 100%;" class="d-flex">
                                <img src="<?php echo $desktop_images . 'csr/csr-madgascar-3.jpg'; ?>" alt="">
                            </div>
                        </div>
                        <div style="grid-column: 9 / span 4; grid-row: 5 / span 2;">
                            <div style="width: 100%;" class="d-flex">
                                <img src="<?php echo $desktop_images . 'csr/csr-madgascar-4.jpg'; ?>" alt="">
                            </div>
                        </div>
                        <div style="grid-column: 1 / span 2; grid-row: 5 / span 2;">
                            <div style="width: 100%;" class="d-flex">
                                <img src="<?php echo $desktop_images . 'csr/csr-madgascar-5.jpg'; ?>" alt="">
                            </div>
                        </div>
                        <div style="grid-column: 3 / span 2; grid-row: 5 / span 2;">
                            <div style="width: 100%;" class="d-flex">
                                <img src="<?php echo $desktop_images . 'csr/csr-madgascar-6.jpg'; ?>" alt="">
                            </div>
                        </div>
                        <div style="grid-column: 5 / span 2; grid-row: 5 / span 2;">
                            <div style="width: 100%;" class="d-flex">
                                <img src="<?php echo $desktop_images . 'csr/csr-madgascar-7.jpg'; ?>" alt="">
                            </div>
                        </div>
                        <div style="grid-column: 7 / span 2; grid-row: 5 / span 2;">
                            <div style="width: 100%;" class="d-flex">
                                <img src="<?php echo $desktop_images . 'csr/csr-madgascar-8.jpg'; ?>" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="container d-flex flex-column justify-content-between align-items-start">
                            <div class="content-container d-flex justify-content-between align-items-start">
                                <div class="txt-content">
                                    ...
                                    <div class="sub-txt">
                                        Excis has recently planted 1000 trees as part of our ongoing efforts to go-green. The government backed project managed by our team based in Madagascar along with family and friends has been a great success and Excis would like to thank all those involved in helping to make this project a reality. Excis is committed to carbon reduction and offsetting programmes.
                                    </div>
                                </div>
                            ...
                            <div class="content-container row-reverse d-flex justify-content-between align-items-start">
                                <div class="txt-content">
                                    ...
                                    <div class="sub-txt">
                                        Team of 67 employees participated in this event. We ensured that saplings were planted at barren land or where deforestation had occurred. Moving forward, our team will regularly monitor the growth of these saplings and will ensure the growth through to their full potential.
                                    </div>
                                </div>
