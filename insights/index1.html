...
<head>
    ...
    <style>
        .tab {
            ...
            border-radius: 8px;
            overflow: hidden;
            /* Ensure smooth transitions by hiding overflow */
        }
        ...
        .tab-content {
            ...
            overflow: hidden;
            padding: 0 15px;
            /* Add padding but collapse it when hidden */
        ...
        .tab-content.open {
            max-height: 500px;
            /* Adjust based on the content's expected height */
            padding: 15px;
        }
...
<body>
    ...
    <div id="case-studies" class="full-container anchor-offset">
        <div style="width: 100%; background: rgba(217, 217, 217);">
            <div style="padding: 80px 15px;" class="main-content-container">
                <div style="font-size: 36px; font-weight: 500; line-height: 54px; color: #F58520;">
                    Case Studies
                </div>
                <div
                    style="max-width: 60%; font-size: 14px; font-weight: 400; line-height: 25px; padding: 20px 0 0; color: rgba(37, 37, 37);">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Dignissimos, voluptatum! Fugiat, minus
                    odit. Accusantium illo quaerat recusandae quidem eum numquam rem quisquam facilis?
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="full-container">
        <div style="width: 100%; background: #fff;">
            <div style="max-width: 100%; margin-inline: auto; position: relative;">
                <div style="height: 100%; padding: 50px 15px 50px;" class="main-content-container">
                    ...
                    <div style="width: fit-content; padding: 14px 50px; margin: 40px auto 0; color: #252525; background: #fff; gap: 12px; border: 1px solid #252525; border-radius: 10px;"
                        class="d-flex justify-content-center align-items-center">
    ...
    <div id="news" class="full-container anchor-offset">
        <div style="width: 100%; background: rgba(217, 217, 217);">
            <div style="padding: 80px 15px;" class="main-content-container">
                <div style="font-size: 36px; font-weight: 500; line-height: 54px; color: #F58520;">
                    News
    ...
    <div class="full-container">
        <div style="width: 100%; background: #fff;">
            <div style="padding: 50px 15px;" class="main-content-container">
                <div style="width: 100%; flex-direction: column; gap: 20px;" class="d-flex justify-content-start">
                    <div style="width: 100%; border: 1px solid rgba(37, 37, 37, 0.1); border-radius: 10px;">
                        <a href="">
                            <div style="margin: 20px; gap: 30px;" class="d-flex justify-content-start">
                                ...
                                <div style=" flex-direction: column;" class="d-flex justify-content-between">
                                    <div>
                                        <div style="height: 20px; margin: 5px 0 0;">
                                            <img loading="lazy" style="width: auto;" src="../assets/images/partner-lenovo.png"
                                                alt="">
                                        </div>
                                        <div
                                            ...
                                            modi dolorum accusamus sint animi.
                                        </div>
                                        <div
                                            style="font-size: 14px; font-weight: 400; line-height: 16px; padding: 10px 0 0; color: rgba(0, 0, 0, 0.5);">
                                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusantium
                                            reprehenderit eum fuga tenetur blanditiis facilis voluptate libero nemo
                                            autem odio voluptatem sed, consequuntur, dolor provident.
                                        </div>
                                    </div>
                                    <div
                        ...
                        <a href="">
                            <div style="margin: 20px; gap: 30px;" class="d-flex justify-content-start">
                                ...
                                <div style=" flex-direction: column;" class="d-flex justify-content-between">
                                    <div>
                                        <div style="height: 20px; margin: 5px 0 0;">
                                            <img loading="lazy" style="width: auto;" src="../assets/images/partner-cisco.png"
                                                alt="">
                                        </div>
                                        <div
                                            style="font-size: 18px; font-weight: 700; line-height: 20px; padding: 15px 0 0; color: #000;">
                                        ...
                                        <div
                                            style="font-size: 14px; font-weight: 400; line-height: 16px; padding: 10px 0 0; color: rgba(0, 0, 0, 0.5);">
                                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Omnis, vero a quia
                                            officia sapiente laboriosam minus neque debitis quo recusandae in architecto
                                            iure suscipit maiores soluta, eveniet aliquam officiis adipisci ipsa
                                            asperiores consequatur porro vel!
                                        </div>
                                    </div>
                                    <div
                                        style="font-size: 14px; font-weight: 500; line-height: 20px; color: rgb(0, 105, 255);">
                        ...
                        <a href="">
                            <div style="margin: 20px; gap: 30px;" class="d-flex justify-content-start">
                                ...
                                <div style=" flex-direction: column;" class="d-flex justify-content-between">
                                    <div>
                                        <div style="height: 20px; margin: 5px 0 0;">
                                            <img loading="lazy" style="width: auto;" src="../assets/images/partner-dell.png"
                                                alt="">
                                        </div>
                                        <div
                                            style="font-size: 18px; font-weight: 700; line-height: 20px; padding: 15px 0 0; color: #000;">
                                        ...
                                        <div
                                            ...
                                            reprehenderit eum fuga tenetur blanditiis facilis voluptate libero nemo
                                            autem
                                            odio voluptatem sed, consequuntur, dolor provident.
                                        </div>
                                    </div>
                                    <div
                                        style="font-size: 14px; font-weight: 500; line-height: 20px; color: rgb(0, 105, 255);">
    ...
    <div id="insights" class="full-container anchor-offset">
        <div style="width: 100%; background: rgba(217, 217, 217);">
            <div style="padding: 80px 15px;" class="main-content-container">
                <div style="font-size: 36px; font-weight: 500; line-height: 54px; color: #F58520;">
                    Insights
