            ...
            <div class="main-content-container">
                <div class="banner-txt d-flex flex-column justify-content-center">
                    <div class="breadcrumb">
                        <a href="<?php echo $desktop_url; ?>">Home</a> - <a href="<?php echo $desktop_url . 'services'; ?>">Services</a> - <span class="page">Cyber Security Consulting</span>
                    </div>
                    ...
                    <div style="padding: 50px 15px;" class="d-flex justify-content-between align-items-center">
                        <div style="max-width: 600px;">
                            <div style="font-size: 30px; font-weight: 500; line-height: 40px; color: #F58520;">
                                Complete Cyber Security Consulting
                            </div>
                            <div style="padding: 25px 0 0; font-size: 14px; font-weight: 400; line-height: 22px; color: #000;">
                                In today’s competitive world, every business confronts its own set of challenges and troubles, from rules and regulations to data security threats. As cyber threats are growing, companies are in need of bringing the best solution to safeguard their environment. Regardless of company size, one-on-one counseling from experienced and skilled cyber security professionals is mandatory to keep pace.
                                <br> <br>
                                Cyber security consulting may look unnecessary for your firm at first glance. But, it is beneficial in pinpointing hidden vulnerabilities, creating the right action plan, and picking up the best technologies to protect your data assets. With the experts’ assistance, you can stay away from potential troubles and travel on the right path to reach your goals.
                            </div>
                        </div>
        ...
        <div style="width: 100%; background: linear-gradient(to bottom, #1B315D, #354D7D);;">
            <div style="height: 100%; padding: 70px 15px;" class="main-content-container">
                <div style="max-width: 700px; margin-inline: auto; color: #fff; font-size: 30px; line-height: 40px; font-weight: 500; text-align: center;">
                    Reasons to seek cyber security consulting service
                </div>
                    ...
                    <div class="support-card">
                        <div class="card-content">
                            ...
                            <div style="padding: 18px 0 0; font-size: 14px; font-weight: 400; line-height: 22px; color: #000;">
                                Experts’ advisory services are designed to fulfill the security project goals in a short time.
                            </div>
                        </div>
                    </div>
                    <div class="support-card">
                        <div class="card-content">
                            ...
                            <div style="padding: 18px 0 0; font-size: 14px; font-weight: 400; line-height: 22px; color: #000;">
                                With the specialized plan, experts help keep your data protected from cyberattacks and similar risks.
                            </div>
                        </div>
                    </div>
                    <div class="support-card">
                        <div class="card-content">
                            <div style="font-size: 24px; font-weight: 700; color: #000;">
                                Budget-Friendly Cybersecurity
                            </div>
                            <div style="padding: 18px 0 0; font-size: 14px; font-weight: 400; line-height: 22px; color: #000;">
                                Implement reliable cyber security strategies that work well with your business budget and model
                            </div>
                        </div>
                    </div>
                    <div class="support-card">
                        <div class="card-content">
                            <div style="font-size: 24px; font-weight: 700; color: #000;">
                                Breach-Resistant Solutions
                            </div>
                            <div style="padding: 18px 0 0; font-size: 14px; font-weight: 400; line-height: 22px; color: #000;">
                                Reduce the likelihood of data breaches by rendering the best security solutions for your business
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div style="padding: 50px 0 0;">
                    <div style="max-width: 700px; margin-inline: auto; color: #fff; font-size: 30px; line-height: 40px; font-weight: 500; text-align: center;">
                        Obtain security awareness training!
                    </div>
                    <div style="max-width: 800px; margin-inline: auto; color: #fff; font-size: 14px; line-height: 24px; font-weight: 400; text-align: center; padding: 20px 0 0;">
                        Companies with a positive cyber security attitude will easily handle all sorts of situations. But, for that, companies need to provide the best security awareness training for their employees. It helps prevent the company from becoming a victim of phishing attacks and other issues.
                        <br> <br>
                        Since the leading security awareness training institute renders the training, the employees will get enough knowledge on the latest cyber issues and compliances. They also become aware of what to do to avoid cyber attacks and ensure the business environment is safe.
                    </div>
                </div>

                <div style="padding: 50px 0 0;">
                    <div style="max-width: 700px; margin-inline: auto; color: #fff; font-size: 30px; line-height: 40px; font-weight: 500; text-align: center;">
                        Need to stay away from cyber threats!
                    </div>
                    <div style="max-width: 800px; margin-inline: auto; color: #fff; font-size: 14px; line-height: 24px; font-weight: 400; text-align: center; padding: 20px 0 0;">
                        Whenever you look for the best cyber security consulting, you can reach Excis. We help companies of all sizes to manage cyber threats and increase their protection. Our expert team will continuously monitor your infrastructure and notifications to avoid breaches and other potential threats.
                        <br> <br>
                        With penetration testing services, we assess your business’s critical security vulnerabilities. Additionally, we help you to deploy compliance practices for obtaining security certifications. We render hourly or on-demand security consulting throughout the year. So, if you need our consulting service, you can reach our destination.
                        <br> <br>
                        Do you still want to know more details about our cyber security consulting? If yes, then you can contact us anytime. Our expert team will be there to assist you!
                    </div>
                </div>
            </div>
        </div>
