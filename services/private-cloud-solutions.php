            ...
            <div class="main-content-container">
                <div class="banner-txt d-flex flex-column justify-content-center">
                    <div class="breadcrumb">
                        <a href="<?php echo $desktop_url; ?>">Home</a> - <a href="<?php echo $desktop_url . 'services'; ?>">Services</a> - <span class="page">Private Cloud Solutions</span>
                    </div>
                    ...
                    <div style="padding: 50px 15px;" class="d-flex justify-content-between align-items-center">
                        <div style="max-width: 600px;">
                            <div style="font-size: 30px; font-weight: 500; line-height: 40px; color: #F58520;">
                                Complete Private Cloud <br> Solutions Service
                            </div>
            ...
            <div style="height: 100%; padding: 70px 15px;" class="main-content-container">
                ...
                <div style="padding: 50px 0 0;">
                    ...
                    <ul style="max-width: 800px; margin-inline: auto; color: #fff; font-size: 14px; line-height: 24px; font-weight: 400; text-align: left; padding: 20px 0 0 20px;">
                        <li>Complete control of hardware and software</li>
                        <li>Able to customize hardware with ease of work</li>
                        <li>Good visibility into security</li>
                        <li>Fully enforced compliance with regulatory standard</li>
                    </ul>
                </div>
                ...
                <div style="padding: 50px 0 0;">
                    ...
                    <ul style="max-width: 800px; margin-inline: auto; color: #fff; font-size: 14px; line-height: 24px; font-weight: 400; text-align: left; padding: 20px 0 0 20px;">
                        <li>Gives complete solutions of private cloud</li>
                        <li>Protect companies to expand the business</li>
                        <li>Fully secured solution for your business</li>
                        <li>Excis offers a network to many companies</li>
                        <li>Deliver 24/7 customer support</li>
                        <li>Provides end-to-end private cloud solutions for small and medium business</li>
                    </ul>
                </div>
            </div>
        </div>
