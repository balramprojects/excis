            ...
            <div class="main-content-container">
                <div class="banner-txt d-flex flex-column justify-content-center">
                    <div class="breadcrumb">
                        <a href="<?php echo $desktop_url; ?>">Home</a> - <a href="<?php echo $desktop_url . 'services'; ?>">Services</a> - <span class="page">WiFi Services</span>
                    </div>
                    ...
                    <div style="padding: 50px 15px;" class="d-flex justify-content-between align-items-center">
                        <div style="max-width: 600px;">
                            <div style="font-size: 30px; font-weight: 500; line-height: 40px; color: #F58520;">
                                Complete WiFi Support<br> Services
                            </div>
                            <div style="padding: 25px 0 0; font-size: 14px; font-weight: 400; line-height: 22px; color: #000;">
                                In the digital world, staying connected is the key for every organization. You can hire our wifi service provider if you need to install and manage a wireless connection. We offer the best wireless LAN plan for all businesses, regardless of size. Planning, designing, installing, and managing the wifi network needs experience and proper skill. Therefore, business owners are hiring professional wifi services for a better solution. We have plenty of wifi service to ensure the assignment’s achievement.
                                <br> <br>
        ...
        <div style="width: 100%; background: linear-gradient(to bottom, #1B315D, #354D7D);;">
            <div style="height: 100%; padding: 70px 15px;" class="main-content-container">
                ...
                <div style="max-width: 800px; margin-inline: auto; color: #fff; font-size: 14px; line-height: 24px; font-weight: 400; text-align: center; padding: 20px 0 0;">
                    Our specialists will conduct the location survey to set up your requirements. Comprehensive wifi design from Excis can include internet management service to maintain and modify the wifi needs of the business. You can save money and time by hiring our network installing service. We can operate to support the newly set up wifi at any size. The followings are some services we offer:
                </div>
                ...
                <div class="support-cards d-flex justify-content-center">
                    <div class="support-card">
                        <div class="card-content">
                            ...
                            <div style="padding: 18px 0 0; font-size: 14px; font-weight: 400; line-height: 22px; color: #000; height: 115px; overflow: auto;">
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Est reiciendis repellendus qui sapiente quos? Laboriosam harum placeat impedit porro eos?
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="support-card">
                        <div class="card-content">
                            ...
                            <div style="padding: 18px 0 0; font-size: 14px; font-weight: 400; line-height: 22px; color: #000; height: 115px; overflow: auto;">
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Nobis odio saepe eaque unde minima culpa accusantium possimus distinctio, facilis beatae!
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="support-card">
                        <div class="card-content">
                            ...
                            <div style="padding: 18px 0 0; font-size: 14px; font-weight: 400; line-height: 22px; color: #000; height: 115px; overflow: auto;">
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Veniam perspiciatis doloribus, saepe id ad quae asperiores laboriosam exercitationem nihil debitis.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="support-card">
                        <div class="card-content">
                            <div style="font-size: 24px; font-weight: 700; color: #000;">
                                Point-to-Point wifi installation ​
                            </div>
                            <div style="padding: 18px 0 0; font-size: 14px; font-weight: 400; line-height: 22px; color: #000; height: 115px; overflow: auto;">
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Eligendi nesciunt aspernatur asperiores recusandae saepe nulla, delectus consectetur iste temporibus dolorum.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="support-card">
                        <div class="card-content">
                            <div style="font-size: 24px; font-weight: 700; color: #000;">
                                WiFi site investigation
                            </div>
                            <div style="padding: 18px 0 0; font-size: 14px; font-weight: 400; line-height: 22px; color: #000; height: 115px; overflow: auto;">
                                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quidem beatae facilis adipisci similique necessitatibus iure ipsum alias minima doloremque obcaecati?
                            </div>
                        </div>
                    </div>
                ...
                <div style="padding: 30px 0 0;">
                    <div style="max-width: 800px; margin-inline: auto; color: #fff; font-size: 14px; line-height: 24px; font-weight: 400; text-align: center; padding: 20px 0 0;">
                        We understand the needs of client investments and provide the wifi solution. Also, we use industry-standard parts for your business that offer a better experience. When you hire our wifi service, you can gain many benefits such as high-speed internet, higher security, dedicated technicians, and high-speed internet.
                    </div>
                </div>
            </div>
        </div>
