            ...
            <div class="main-content-container">
                <div class="banner-txt d-flex flex-column justify-content-center">
                    <div class="breadcrumb">
                        <a href="<?php echo $desktop_url; ?>">Home</a> - <a href="<?php echo $desktop_url . 'services'; ?>">Services</a> - <span class="page">Office 365 and G-Suite Migration + Integration </span>
                    </div>
                    ...
                    <div style="padding: 50px 15px;" class="d-flex justify-content-between align-items-center">
                        <div style="max-width: 600px;">
                            <div style="font-size: 30px; font-weight: 500; line-height: 40px; color: #F58520;">
                                Complete Office 365 and G-Suite <br> Migration + Integration Service
                            </div>
                    ...
                    <div class="support-card">
                        <div class="card-content">
                            ...
                            <div style="padding: 18px 0 0; font-size: 14px; font-weight: 400; line-height: 22px; color: #000;">
                                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Maxime quaerat in laborum enim, repellendus consectetur dolorem aperiam officia deleniti nihil eos labore dolor pariatur sed?
                            </div>
                        </div>
                    </div>
                    <div class="support-card">
