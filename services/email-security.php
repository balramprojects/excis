            ...
            <div class="main-content-container">
                <div class="banner-txt d-flex flex-column justify-content-center">
                    <div class="breadcrumb">
                        <a href="<?php echo $desktop_url; ?>">Home</a> - <a href="<?php echo $desktop_url . 'services'; ?>">Services</a> - <span class="page">Email Security</span>
                    </div>
        ...
        <div style="width: 100%; background: linear-gradient(to bottom, #1B315D, #354D7D);;">
            <div style="height: 100%; padding: 70px 15px;" class="main-content-container">
                ...
                <div style="padding: 50px 0 0;">
                    ...
                    <div style="max-width: 800px; margin-inline: auto; color: #fff; font-size: 14px; line-height: 24px; font-weight: 400; text-align: center; padding: 20px 0 0;">
                        We implement DMARC to protect your company from the hacker. DMARC stands for Domain-based message authentication reporting, and conformance is the best email authentication system. It helps to safeguard the organization’s email domain from phishing scams and email spoofing. Implementing this technique spots the hacker’s fraud emails by confirming the sender’s identity. It lets the person show that their email is protected and leads receivers on what to do when verification fails.
                        <br> <br>
