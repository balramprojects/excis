                                    ...
                                    <div style="width: 100%; background: #FAF9F6;">
                                        <div style="height: 100%; padding: 0 15px;" class="main-content-container">
                                            <div style="width: 100%; gap: 20px; padding: 20px 0 0;" class="d-flex justify-content-center align-items-start">
                                                <div style="width: 100%;">
                                                    <p style="font-size: 18px; font-weight: 700; padding-bottom: 10px; color: #F58520; border-bottom: 1px solid rgb(37, 37, 37, 0.2);">Infrastructure</p>
                                                ...
                                                <div style="width: 100%;">
                                                    <p style="font-size: 18px; font-weight: 700; padding-bottom: 10px; color: #252525; border-bottom: 1px solid rgb(37, 37, 37, 0.2);">Infrastructure</p>
                ...
                <div style="width: 100%;" class="d-flex justify-content-center">
                    ...
                    <div style="height: 520px; position: relative; display: flex; align-items: center;">
                        <div style="width: 460px; display: flex; opacity: 0.2;">
                            <img loading="lazy" src="images/banner-world.png" alt="">
                        </div>
    ...
    <div class="full-container">
        <div style="width: 100%; background: #fff;">
            <div style="max-width: 100%; margin-inline: auto; position: relative;">
                <div style="width: 290px; height: 416px; background-image: url('images/abstract-bg-btm.png'); background-size: 100% 100%; background-repeat: no-repeat; opacity: 0.6; position: absolute; bottom: 0; left: 0;"></div>
                <div style="width: 290px; height: 416px; background-image: url('images/abstract-bg.png'); background-size: 100% 100%; background-repeat: no-repeat; opacity: 0.6; position: absolute; top: 0; right: 0;"></div>

                <div style="height: 100%; padding: 50px 15px;" class="main-content-container">
                    <div style="width: 100%;">
                        <div style="width: fit-content; font-size: 13px; font-weight: 700; padding: 7px 90px 7px 10px; color: #FAF9F6; background: #252525; border-radius: 4px;">
                            ABOUT US
                        </div>
                        <div class="d-flex justify-content-between align-items-start">
                            <div>
                                ...
                                <div style="font-size: 18px; font-weight: 400; padding: 15px 0 0; color: #000;">
                                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Repellat minus cum veritatis ipsum neque unde.
                                </div>
                            </div>
                            <div style="width: fit-content; padding: 14px 30px; margin: 25px 0 0; color: #FAF9F6; background: #252525; gap: 12px; border-radius: 10px;" class="d-flex justify-content-center align-items-center">
                        ...
                        <div style="height: 100%; padding: 20px 0 0 0; gap: 30px;" class="d-flex justify-content-between">
                            <div style="width: 100%;" class="">
                                <div style="max-width: 100%; padding: 50px; border-radius: 10px;" class="about-us-box d-flex justify-content-between align-items-center">
                                    <div>
                                        <div style="font-size: 24px; font-weight: 700;" class="heading">
                                            4 Hour SLA
                                        </div>
                                        <div style="width: 60%; font-size: 14px; font-weight: 400; line-height: 25px; padding: 20px 0 0; text-wrap: wrap;" class="subtxt">
                                            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Fuga aliquid iusto sunt dignissimos eum architecto, natus mollitia temporibus nulla rem.
                                        </div>
                                    </div>
                                    <div style="width: 300px;">
                                        <img loading="lazy" style="height: auto;" src="images/about-us-creative.png" alt="">
                                    </div>
                                </div>
                                <div style="max-width: 100%; padding: 50px; margin-top: 30px; border-radius: 10px;" class="about-us-box d-flex justify-content-between align-items-center">
                                    <div>
                                        <div style="font-size: 24px; font-weight: 700;" class="heading">
                                            24/7 Support
                                        </div>
                            ...
                            <div style="width: 55%; border-radius: 10px;" class="about-us-box">
                                <div style="height: 100%; flex-direction: column;" class="d-flex justify-content-between">
                                    <div>
                                        <div class="heading" style="font-size: 24px; font-weight: 700; padding: 50px 50px 0 50px;">
                                            Flexible IT Solutions
                                        </div>

                                        <div class="subtxt" style="font-size: 16px; font-weight: 400; line-height: 25px; padding: 15px 50px 0 50px;">
                                            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quibusdam illum aperiam voluptates, numquam facere repellendus.
                                        </div>
                                    </div>
                                    <div style="padding: 50px;">
                                        <div style="width: 85%; margin-inline: auto;">
                                            <img loading="lazy" src="images/about-us-creative.png" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div style="width: 100%; background: #121820;">
            ...
            <div style="height: 100%; padding: 50px 15px;" class="main-content-container">
                <div style="width: 100%;">
                    ...
                    <div style="max-width: 500px; font-size: 14px; font-weight: 400; line-height: 22px; text-align: center; padding: 10px 0 0; margin-inline: auto; color: rgb(250, 249, 246, 0.6);">
                    ...
                    <div style="width: 100%; padding: 50px 0 0; display: flex; justify-content: center;">
                        <div style="max-width: 800px; position: relative;">
                            ...
                            <div style="max-width: 100%; display: flex;">
                                <img style="width: 100%; height: 100%;" src="images/world-map.png" alt="">
                            </div>
                            ...
                            <div class="countries-position" style="position: absolute; top: 63%; left: 67.1%;">
                                ...
                                <div class="countries-spot-container">
                                    <div style="font-family: 'Manrope', sans-serif; font-size: 16px; font-weight: 600; color: #F58520; padding: 0 0 3px; text-transform: uppercase;">India</div>
                                    <ul style="font-family: 'Manrope', sans-serif; font-size: 12px; font-weight: 400; margin: 10px 0 0 15px; text-transform: uppercase;">
                            ...
                            <div class="countries-position" style="position: absolute; top: 60%; left: 18.5%;">
                                ...
                                <div class="countries-spot-container">
                                    <div style="font-family: 'Manrope', sans-serif; font-size: 16px; font-weight: 600; color: #F58520; padding: 0 0 3px; text-transform: uppercase;">USA</div>
                                    <ul style="font-family: 'Manrope', sans-serif; font-size: 12px; font-weight: 400; margin: 10px 0 0 15px; text-transform: uppercase;">
                            ...
                            <div class="countries-position" style="position: absolute; top: 78.8%; left: 59.7%;">
                                <div class="countries-spot-point"></div>
                                <div class="countries-spot-container">
                                    <div style="font-family: 'Manrope', sans-serif; font-size: 16px; font-weight: 600; color: #F58520; padding: 0 0 3px; text-transform: uppercase;">Madagascar</div>
                                    <ul style="font-family: 'Manrope', sans-serif; font-size: 12px; font-weight: 400; margin: 10px 0 0 15px; text-transform: uppercase;">
                            ...
                            <div class="countries-position" style="position: absolute; top: 85.5%; left: 52.2%;">
                                <div class="countries-spot-point"></div>
                                <div class="countries-spot-container">
                                    <div style="font-family: 'Manrope', sans-serif; font-size: 16px; font-weight: 600; color: #F58520; padding: 0 0 3px; text-transform: uppercase;">South Africa</div>
                                    <ul style="font-family: 'Manrope', sans-serif; font-size: 12px; font-weight: 400; margin: 10px 0 0 15px; text-transform: uppercase;">
                            ...
                            <div class="countries-position" style="position: absolute; top: 45%; left: 46.1%;">
                                <div class="countries-spot-point blue"></div>
                                <div class="countries-spot-container">
                                    <div style="font-family: 'Manrope', sans-serif; font-size: 16px; font-weight: 600; color: #F58520; padding: 0 0 3px; text-transform: uppercase;">United Kingdom</div>
                                    <ul style="font-family: 'Manrope', sans-serif; font-size: 12px; font-weight: 400; margin: 10px 0 0 15px; text-transform: uppercase;">
                            ...
                            <div class="countries-position" style="position: absolute; top: 41%; left: 56%;">
                                <div class="countries-spot-point"></div>
                                <div class="countries-spot-container">
                                    <div style="font-family: 'Manrope', sans-serif; font-size: 16px; font-weight: 600; color: #F58520; padding: 0 0 3px; text-transform: uppercase;">Russia</div>
                                    <ul style="font-family: 'Manrope', sans-serif; font-size: 12px; font-weight: 400; margin: 10px 0 0 15px; text-transform: uppercase;">
                            ...
                            <div class="countries-position" style="position: absolute; top: 67%; left: 73.8%;">
                                <div class="countries-spot-point"></div>
                                <div class="countries-spot-container">
                                    <div style="font-family: 'Manrope', sans-serif; font-size: 16px; font-weight: 600; color: #F58520; padding: 0 0 3px; text-transform: uppercase;">Thailand</div>
                                    <ul style="font-family: 'Manrope', sans-serif; font-size: 12px; font-weight: 400; margin: 10px 0 0 15px; text-transform: uppercase;">
                        ...
                        <div style="padding: 30px 0 0;">
                            <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 30px;">
                                <div class="services-cards d-flex justify-content-between">
                                    <div style="padding: 20px 25px;">
                                        <div style="width: 100px; margin-inline: auto;" class="d-flex">
                                            <img loading="lazy" src="images/help-desk-icon.png" alt="">
                                        </div>
                                ...
                                <div class="services-cards d-flex justify-content-between">
                                    <div style="padding: 20px 25px;">
                                        <div style="width: 100px; margin-inline: auto;" class="d-flex">
                                            <img loading="lazy" src="images/data-security-icon.png" alt="">
                                        </div>
                                ...
                                <div class="services-cards d-flex justify-content-between">
                                    <div style="padding: 20px 25px;">
                                        <div style="width: 100px; margin-inline: auto;" class="d-flex">
                                            <img loading="lazy" src="images/web-security-icon.png" alt="">
                                        </div>
                                ...
                                <div class="services-cards d-flex justify-content-between">
                                    <div style="padding: 20px 25px;">
                                        <div style="width: 100px; margin-inline: auto;" class="d-flex">
                                            <img loading="lazy" src="images/application-security-icon.png" alt="">
                                        </div>
                                ...
                                <div class="services-cards d-flex justify-content-between">
                                    <div style="padding: 20px 25px;">
                                        <div style="width: 100px; margin-inline: auto;" class="d-flex">
                                            <img loading="lazy" src="images/hybrid-cloud-icon.png" alt="">
                                        </div>
                ...
                <div style="width: 100%; padding: 80px 0;">
                    <div style="max-width: 1000px; height: 110px; margin-inline: auto;" class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <p style="font-size: 24px; font-weight: 300; padding: 10px 0 0; color: #FAF9F6;">Tickets Per Month</p>
                        </div>
                        ...
                        <div>
                            ...
                            <p style="font-size: 24px; font-weight: 300; padding: 10px 0 0; color: #FAF9F6;">Enterprise Clients</p>
                        </div>
                        <div style="height: 100%; padding: 0 .5px; margin: 0 40px; background: #fff;"></div>
                        <div>
                            <p style="font-size: 80px; font-weight: 700; line-height: 80px; color: #FAF9F6;">100+</p>
                            <p style="font-size: 24px; font-weight: 300; padding: 10px 0 0; color: #FAF9F6;">Countries</p>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div style="width: 100%; padding: 20px; background: #FAF9F6; border: 1px solid rgb(37, 37, 37, 0.2); border-radius: 10px; gap: 20px;" class="core-values-card d-flex justify-content-start align-items-center">
                                    <div style="height: 70px; width: 70px; border-radius: 50%;" class="d-flex justify-content-center align-items-center">
                                        <div style="height: 55px; width: 55px; background: linear-gradient(to bottom, #1B315D, #354D7D); border-radius: 50%;" class="drop d-flex justify-content-center align-items-center">
                                            <div style="width: 20px;" class="d-flex">
                                                <img loading="lazy" src="images/dollar-icon.png" alt="">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div style="width: 100%; padding: 20px; background: #FDFDFD; border: 1px solid rgb(37, 37, 37, 0.1); border-radius: 10px;" class="case-studies-card">
                                    <div style="width: 100%; height: 176px; background: linear-gradient(to bottom, #1B315D, #354D7D); border-radius: 10px;" class="d-flex justify-content-center align-items-center">
                                        <div style="width: 140px;" class="d-flex">
                                            <img loading="lazy" src="images/case-studies-card-creative.png" alt="">
                                        </div>
                                    </div>
                                    <div style="width: 100%; padding: 10px 5px;">
                                        ...
                                        <div style="font-size: 14px; font-weight: 400; line-height: 24px; padding: 10px 0 0; color: rgb(0, 0, 0, 0.5);">
                                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Nihil dolorum distinctio vel praesentium voluptatibus possimus illum et velit harum neque.
                                        </div>

                                        <div style="padding: 30px 0 0;">
                                            <a href="#" style="font-size: 12px; font-weight: 700; color: #252525;">Read More</a>
                                        </div>
                                    </div>
                                </div>
        ...
        <div style="width: 100%; background: rgba(18, 24, 32, 1);">
            <div style="height: 100%; padding: 80px 15px;" class="main-content-container">
                <div style="font-size: 34px; font-weight: 500; color: #fff; text-align: center;">
                    Clients we have had privilege to work with
                </div>
                ...
                <div style="margin-top: 50px; flex-wrap: wrap;" class="d-flex">
                    <div style="height: 100px; flex: 1;" class="partner-cards d-flex justify-content-center align-items-center">
                        <div style="height: 25px;" class="d-flex">
                            <img loading="lazy" style="width: auto;" src="images/partner-microsoft.png" alt="">
                        </div>
                    </div>
                    <div style="height: 100px; flex: 1;" class="partner-cards d-flex justify-content-center align-items-center">
                        <div style="height: 30px;" class="d-flex">
                            <img loading="lazy" style="width: auto;" src="images/partner-lenovo.png" alt="">
                        </div>
                    </div>
                    <div style="height: 100px; flex: 1;" class="partner-cards d-flex justify-content-center align-items-center">
                        <div style="height: 60px;" class="d-flex">
                            <img loading="lazy" style="width: auto;" src="images/partner-dell.png" alt="">
                        </div>
                    </div>
                    <div style="height: 100px; flex: 1;" class="partner-cards d-flex justify-content-center align-items-center">
                        <div style="height: 20px;" class="d-flex">
                            <img loading="lazy" style="width: auto;" src="images/partner-vmware.png" alt="">
                        </div>
                    </div>
                    <div style="height: 100px; flex: 1;" class="partner-cards d-flex justify-content-center align-items-center">
                        <div style="height: 35px;" class="d-flex">
                            <img loading="lazy" style="width: auto;" src="images/partner-deutsche-bank.png" alt="">
                        </div>
                    </div>
                    <div style="height: 100px; flex: 1;" class="partner-cards d-flex justify-content-center align-items-center">
                        <div style="height: 35px;" class="d-flex">
                            <img loading="lazy" style="width: auto;" src="images/partner-cisco.png" alt="">
                        </div>
                    </div>
                    <div style="height: 100px; flex: 1;" class="partner-cards d-flex justify-content-center align-items-center">
                        <div style="height: 25px;" class="d-flex">
                            <img loading="lazy" style="width: auto;" src="images/partner-nokia.png" alt="">
                        </div>
                    </div>
                    <div style="height: 100px; flex: 1;" class="partner-cards d-flex justify-content-center align-items-center">
                        <div style="height: 25px;" class="d-flex">
                            ...
                            <div style="width: 50%; height: 100%;">
                                <div style="height: 350px; margin: 20px 20px 20px 30px; flex-direction: column;" class="d-flex justify-content-between">
                                    ...
                                    <div style="font-size: 24px; font-weight: 600; line-height: 35px; color: #000;">
                                        Call us at <span><a href="tel:+44 1344930900" style="color: #000;">+44 1344930900</a></span>
                                    </div>
                                    <div>
                                        <div style="font-size: 24px; font-weight: 600; line-height: 35px; color: #000;">
                                            Your benefits:
                            ...
                            <div style="margin: 70px 30px 20px 0; background: #fff; max-width: 100%; height: 770px; box-shadow: 0 0 10px 5px rgb(0, 0, 0, 0.2);">
                                ...
                                <div>
                                    <div style="gap: 30px; margin: 20px 30px;" class="d-flex">
                                        <div style="width: 100%;">
                                            <label for="firstName" style="font-size: 14px; font-weight: 400; color: rgb(0, 0, 0, 0.7);">First Name</label> <br>
                                        ...
                                        <div style="width: 100%;">
                                            <label for="lastName" style="font-size: 14px; font-weight: 400; color: rgb(0, 0, 0, 0.7);">Last Name</label> <br>
                                    ...
                                    <div style="margin: 20px 30px;" class="d-flex">
                                        <div style="width: 100%;">
                                            <label for="companyName" style="font-size: 14px; font-weight: 400; color: rgb(0, 0, 0, 0.7);">Company / Organization</label> <br>
                                    ...
                                    <div style="margin: 20px 30px;" class="d-flex">
                                        <div style="width: 100%;">
                                            <label for="companyEmail" style="font-size: 14px; font-weight: 400; color: rgb(0, 0, 0, 0.7);">Company Email</label> <br>
                                    ...
                                    <div style="margin: 20px 30px;" class="d-flex">
                                        <div style="width: 100%;">
                                            <label for="phoneNumber" style="font-size: 14px; font-weight: 400; color: rgb(0, 0, 0, 0.7);">Phone</label> <br>
                                    ...
                                    <div style=" margin: 20px 30px;" class="d-flex">
                                        <div style="width: 100%;">
                                            <p style="font-size: 14px; font-weight: 400; color: rgb(0, 0, 0, 0.7);">How Can We Help You?</p>
                                    ...
                                    <div style="margin: 20px 30px; overflow: hidden;" class="d-flex">
                                        <div style="width: 99%;">
                                            <label for="message" style="font-size: 14px; font-weight: 400; color: rgb(0, 0, 0, 0.7);">Message</label> <br>
                ...
                <div style="width: 100%; gap: 80px;" class="d-flex justify-content-between align-items-start">
                    <div>
                        ...
                        <div style="font-size: 13px; font-weight: 300; line-height: 20px; letter-spacing: 1px; padding: 15px 0 0; color: rgba(250, 249, 246, 1);">
                            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Dolores, repellat? Lorem ipsum dolor sit amet, consectetur adipisicing elit. Obcaecati temporibus tenetur, necessitatibus officiis quisquam consectetur. Blanditiis autem ipsum eos aut?
                        </div>
                        <div style="width: 60%; padding: 30px 0 0;" class="d-flex justify-content-between align-items-center">
                            <div style="height: 22px;">
                                <img src="images/facebook.png" style="width: auto;" alt="">
                            </div>
                            <div style="height: 22px;">
                                <img src="images/youtube.png" style="width: auto;" alt="">
                            </div>
                            <div style="height: 22px;">
                                <img src="images/instagram.png" style="width: auto;" alt="">
                            </div>
                            <div style="height: 22px;">
                                <img src="images/twitter.png" style="width: auto;" alt="">
                            </div>
                            <div style="height: 22px;">
                                <img src="images/linkedin.png" style="width: auto;" alt="">
                            </div>
                        </div>
                    </div>
                    <div>
                        <div>
                            ...
                            <div style="padding: 5px 0 0; line-height: 24px;">
                                <a href="#" style="font-size: 14px; font-weight: 400; color: rgba(250, 249, 246, 1); text-wrap: nowrap;">Data Center Support</a>
                            </div>
                            <div style="padding: 5px 0 0; line-height: 24px;">
                                <a href="#" style="font-size: 14px; font-weight: 400; color: rgba(250, 249, 246, 1); text-wrap: nowrap;">End-User Support</a>
                            </div>
                            <div style="padding: 5px 0 0; line-height: 24px;">
                                <a href="#" style="font-size: 14px; font-weight: 400; color: rgba(250, 249, 246, 1); text-wrap: nowrap;">Audio-Visual</a>
                            </div>
                            <div style="padding: 5px 0 0; line-height: 24px;">
                                <a href="#" style="font-size: 14px; font-weight: 400; color: rgba(250, 249, 246, 1); text-wrap: nowrap;">WiFi Services</a>
                            </div>
                            <div style="padding: 5px 0 0; line-height: 24px;">
                                <a href="#" style="font-size: 14px; font-weight: 400; color: rgba(250, 249, 246, 1); text-wrap: nowrap;">Cybersecurity Consulting</a>
                            </div>
                            <div style="padding: 5px 0 0; line-height: 24px;">
                                <a href="#" style="font-size: 14px; font-weight: 400; color: rgba(250, 249, 246, 1); text-wrap: nowrap;">API Integration</a>
                            </div>
                            <div style="padding: 5px 0 0; line-height: 24px;">
                            ...
                            <div style="padding: 5px 0 0; line-height: 24px;">
                                <a href="#" style="font-size: 14px; font-weight: 400; color: rgba(250, 249, 246, 1); text-wrap: nowrap;">All Services &nbsp; -></a>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div style="padding: 10px 0 0; line-height: 24px;">
                                <a href="#" style="font-size: 14px; font-weight: 400; color: rgba(250, 249, 246, 1); text-wrap: nowrap;">Why Excis</a>
                            </div>
                            <div style="padding: 5px 0 0; line-height: 24px;">
                                <a href="#" style="font-size: 14px; font-weight: 400; color: rgba(250, 249, 246, 1); text-wrap: nowrap;">Career Opportunities</a>
                            </div>
                            <div style="padding: 5px 0 0; line-height: 24px;">
                    ...
                    <div>
                        <div>
                            ...
                            <div style="padding: 5px 0 0; line-height: 24px;">
                                <a href="#" style="font-size: 14px; font-weight: 400; color: rgba(250, 249, 246, 1); text-wrap: nowrap;">Life Sciences</a>
                            </div>
                            <div style="padding: 5px 0 0; line-height: 24px;">
                                <a href="#" style="font-size: 14px; font-weight: 400; color: rgba(250, 249, 246, 1); text-wrap: nowrap;">Financial Services (FS&I)</a>
                            </div>
                            <div style="padding: 5px 0 0; line-height: 24px;">
                            ...
                            <div style="padding: 5px 0 0; line-height: 24px;">
                                <a href="#" style="font-size: 14px; font-weight: 400; color: rgba(250, 249, 246, 1); text-wrap: nowrap;">Public Sector</a>
                            </div>
                            <div style="padding: 5px 0 0; line-height: 24px;">
                            ...
                            <div style="padding: 5px 0 0; line-height: 24px;">
                                <a href="#" style="font-size: 14px; font-weight: 400; color: rgba(250, 249, 246, 1); text-wrap: nowrap;">IT & Consulting</a>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div style="padding: 10px 0 0; line-height: 24px;">
                                <a href="#" style="font-size: 14px; font-weight: 400; color: rgba(250, 249, 246, 1); text-wrap: nowrap;">Blogs/Case Studies</a>
                            </div>
                            <div style="padding: 5px 0 0; line-height: 24px;">
                                <a href="#" style="font-size: 14px; font-weight: 400; color: rgba(250, 249, 246, 1); text-wrap: nowrap;">News</a>
                            </div>
                            <div style="padding: 5px 0 0; line-height: 24px;">
                                <a href="#" style="font-size: 14px; font-weight: 400; color: rgba(250, 249, 246, 1); text-wrap: nowrap;">Research & Development</a>
                            </div>
                        </div>
                    </div>
                    <div>
                        ...
                        <div style="padding: 20px 0 0; gap: 10px;" class="d-flex justify-content-between align-itemcenter">
                            <div style="width: 60px;" class="d-flex">
                                <img src="images/iso-1.png" alt="">
                            </div>
                            <div style="width: 60px;" class="d-flex">
                                <img src="images/iso-2.png" alt="">
                            </div>
                            <div style="width: 60px;" class="d-flex">
                                <img src="images/iso-3.png" alt="">
                            </div>
                            <div style="width: 60px;" class="d-flex">
                                <img src="images/iso-4.png" alt="">
                            </div>
                        </div>
                        <div style="padding: 15px 0 0;">
                            <div style="width: 100px;" class="d-flex">
                                <img src="images/cyber-essentials.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div style="height: 70px;" class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex justify-content-center align-items-center">
                        <div style="padding: 0 15px 0;">
                            <a href="" style="font-size: 14px; font-weight: 400; color: rgba(250, 249, 246, 1);">General Policies</a>
                        </div>
                        <div style="padding: 0 15px 0;">
                            <a href="" style="font-size: 14px; font-weight: 400; color: rgba(250, 249, 246, 1);">Privacy/ Cookies Policy</a>
                        </div>
                        <div style="padding: 0 15px 0;">
                            <a href="" style="font-size: 14px; font-weight: 400; color: rgba(250, 249, 246, 1);">Terms and Conditions</a>
                        </div>
                    </div>
                </div>
            </div>
